...
describe OwnersController do
  ...
  describe "GET index" do
    it "assigns all owners as @owners" do
      ...
      puts owner.inspect
      assigns(:owners).last.should eq(owner)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved owner as @owner" do
        ...
        post :create, {:owner => { "name" => "invalid value" }}, valid_session
        assigns(:owner).should be_a_new(Owner)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested owner" do
        ...
        Owner.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => owner.to_param, :owner => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the owner as @owner" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Owner.any_instance.stub(:save).and_return(false)
        put :update, {:id => owner.to_param, :owner => { "name" => "invalid value" }}, valid_session
        assigns(:owner).should eq(owner)
      end
